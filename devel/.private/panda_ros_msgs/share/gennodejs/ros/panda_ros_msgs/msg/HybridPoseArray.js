...
let HybridPose = require('./HybridPose.js');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class HybridPoseArray {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.poses.forEach((val) => {
      bufferOffset = HybridPose.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new HybridPoseArray(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.poses[i] = HybridPose.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.poses.forEach((val) => {
      length += HybridPose.getMessageSize(val);
    });
    return length + 4;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new HybridPoseArray(null);
    ...
    if (msg.poses !== undefined) {
      ...
      for (let i = 0; i < resolved.poses.length; ++i) {
        resolved.poses[i] = HybridPose.Resolve(msg.poses[i]);
      }
    }
    else {
      resolved.poses = []
...
module.exports = HybridPoseArray;
