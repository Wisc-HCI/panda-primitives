...
if("TRUE" STREQUAL "TRUE")
  set(rviz_camera_stream_SOURCE_PREFIX /workspace/src/rviz_camera_stream)
  set(rviz_camera_stream_DEVEL_PREFIX /workspace/devel/.private/rviz_camera_stream)
  ...
  set(rviz_camera_stream_INSTALL_PREFIX /workspace/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz_camera_stream' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/src/rviz_camera_stream/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /workspace/devel/.private/rviz_camera_stream/lib;/workspace/devel/lib;/opt/ros/noetic/lib)
