...
"""autogenerated by genpy from authoring_msgs/AuthoringActionResult.msg. Do not edit."""
import codecs
import sys
...
class AuthoringActionResult(genpy.Message):
  _md5sum = "93610277e835d86fd85f9117a9bdf45a"
  _type = "authoring_msgs/AuthoringActionResult"
...
bool data"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','authoring_msgs/AuthoringResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AuthoringActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = authoring_msgs.msg.AuthoringResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = authoring_msgs.msg.AuthoringResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.success.data,) = _get_struct_B().unpack(str[start:end])
      self.result.success.data = bool(self.result.success.data)
      return self
