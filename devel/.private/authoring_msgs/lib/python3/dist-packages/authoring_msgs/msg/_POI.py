...
"""autogenerated by genpy from authoring_msgs/POI.msg. Do not edit."""
import codecs
import sys
...
class POI(genpy.Message):
  _md5sum = "4537f0ac14a21e77b6975b4bbfc9188a"
  _type = "authoring_msgs/POI"
...
float64 w
"""
  __slots__ = ['type','id','state','age','pose']
  _slot_types = ['std_msgs/String','uint8','std_msgs/String','uint8','geometry_msgs/PoseStamped']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_B3I().pack(_x.age, _x.pose.header.seq, _x.pose.header.stamp.secs, _x.pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.state.data = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.state.data = str[start:end]
      _x = self
      start = end
      end += 13
      (_x.age, _x.pose.header.seq, _x.pose.header.stamp.secs, _x.pose.header.stamp.nsecs,) = _get_struct_B3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
