...
"""autogenerated by genpy from authoring_msgs/POIArray.msg. Do not edit."""
import codecs
import sys
...
class POIArray(genpy.Message):
  _md5sum = "705692ced92474947d1df89af3eb8c54"
  _type = "authoring_msgs/POIArray"
...
"""
  __slots__ = ['poi_array']
  _slot_types = ['authoring_msgs/POI[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(POIArray, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.poi_array is None:
        self.poi_array = []
    else:
      self.poi_array = []
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.poi_array)
      buff.write(_struct_I.pack(length))
      for val1 in self.poi_array:
        _v1 = val1.type
        _x = _v1.data
        length = len(_x)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v25.data = str[start:end].decode('utf-8', 'rosmsg')
        else:
